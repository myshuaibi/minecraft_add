...
public abstract class CopperarmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 8, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("ambient.cave")), () -> Ingredient.of(new ItemStack(Items.COPPER_INGOT)), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("minecraft_add:copper_"))), 0f,
					0f);
			registerHelper.register(ResourceLocation.parse("minecraft_add:copper_armor"), armorMaterial);
	...
	public static class Helmet extends CopperarmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.minecraft_add.copper_armor_helmet.description_0"));
		}
	}
	...
	public static class Chestplate extends CopperarmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.minecraft_add.copper_armor_chestplate.description_0"));
		}
	}
	...
	public static class Leggings extends CopperarmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.minecraft_add.copper_armor_leggings.description_0"));
		}
	}
	...
	public static class Boots extends CopperarmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, context, list, flag);
			list.add(Component.translatable("item.minecraft_add.copper_armor_boots.description_0"));
		}
	}
}
