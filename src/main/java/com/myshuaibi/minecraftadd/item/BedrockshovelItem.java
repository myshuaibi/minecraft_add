...
public class BedrockshovelItem extends ShovelItem {
	...
	public static void handleToolDamage(ModifyDefaultComponentsEvent event) {
		event.modify(MinecraftAddModItems.BEDROCK_SHOVEL.get(), builder -> builder.remove(DataComponents.MAX_DAMAGE));
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.minecraft_add.bedrock_shovel.description_0"));
	}
}
